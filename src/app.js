...
app.get('/kanban', (req, res) => res.sendFile(path.join(publicDir, 'kanban.html')));
app.get('/calendar', (req, res) => res.sendFile(path.join(publicDir, 'calendar.html')));
app.get('/analytics', (req, res) => res.sendFile(path.join(publicDir, 'analytics.html')));
